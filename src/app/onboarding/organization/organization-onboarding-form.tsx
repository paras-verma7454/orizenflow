      ...
      <Card className="w-full">
        <CardHeader>
          ...
          <p className="text-sm text-muted-foreground">
            Organization name is required. Add at least one public link: website
            or LinkedIn.
          </p>
        </CardHeader>
        <CardContent>
              ...
              <form.Field name="websiteUrl">
                {(field) => {
                  ...
                  return (
                    <Field data-invalid={isInvalid}>
                      <FieldLabel htmlFor={field.name}>
                        Website URL (required if LinkedIn is empty)
                      </FieldLabel>
                      <Input
                        id={field.name}
                        type="url"
                      ...
                      />
                      <FieldDescription>
                        Provide website URL or LinkedIn URL.
                      </FieldDescription>
                      {isInvalid && (
                        <FieldError errors={field.state.meta.errors} />
                      )}
              ...
              <form.Field name="linkedinUrl">
                {(field) => {
                  ...
                  return (
                    <Field data-invalid={isInvalid}>
                      <FieldLabel htmlFor={field.name}>
                        LinkedIn URL (required if Website is empty)
                      </FieldLabel>
                      <Input
                        id={field.name}
                        type="url"
