...
export interface AnimatedClockHandle {
  startAnimation: () => void;
  stopAnimation: () => void;
}

interface AnimatedClockProps extends HTMLAttributes<HTMLDivElement> {
  size?: number;
}
...
const AnimatedClock = forwardRef<AnimatedClockHandle, AnimatedClockProps>(
